...
class SM_CustomLogin{

	public static function sm_custom_login(){

		$module = $_REQUEST['module'];
		$action = $_REQUEST['action'];

		if($module == 'Users' && $action == 'Login'){
			echo '<script>$(document).ready(function(){$(".p_login").remove();});</script>';
			require_once('modules/SM_CustomLogin/views/view.list.php');
		}
