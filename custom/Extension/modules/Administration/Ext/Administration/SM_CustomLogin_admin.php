...
if(preg_match( "/^6.*/", $sugar_version) ) {
    $admin_option_defs['Administration']['customlogin_info']= array('helpInline','LBL_CUSTOMLOGIN_TITLE','LBL_CUSTOMLOGIN_DESCRIPTION','./index.php?module=SM_CustomLogin&action=settings');
} else {
    $admin_option_defs['Administration']['customlogin_info']= array('helpInline','LBL_CUSTOMLOGIN_TITLE','LBL_CUSTOMLOGIN_DESCRIPTION','javascript:parent.SUGAR.App.router.navigate("#bwc/index.php?module=SM_CustomLogin&action=settings", {trigger: true});');
}

$admin_group_header[]= array('LBL_CUSTOMLOGIN','',false,$admin_option_defs, '');
