 ...
 ********************************************************************************/
*}
{assign var="_DefaultLoginTemplate" value="modules/SM_CustomLogin/tpls/Login.default.tpl"}
{assign var="_CustomLoginTemplate" value="modules/SM_CustomLogin/tpls/Login.Customcall.tpl"}
{assign var="_CustomLoginTemplateFullPath" value="$_CustomLoginTemplate"}

{if file_exists($_CustomLoginTemplateFullPath)}
	{include file=$_CustomLoginTemplateFullPath}
{else}
